  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "grid min-w-[8rem] items-stretch gap-1.5 rounded-md border bg-background p-2.5 text-xs shadow-xl",
          className
        )}
      >
                  ...
                  <>
                    {!hideIndicator && (
                      ...
                      >
                        ...
                        {indicator === "line" && (
                          <div
                            className="h-2.5 w-1 shrink-0 bg-[--color-bg]"
                            style={
                              {
                                "--color-bg": indicatorColor,
                              } as React.CSSProperties
                        ...
                        {indicator === "dashed" && (
                          <div
                            className="h-2.5 w-1 shrink-0 border-y-2 border-dashed border-[--color-bg]"
                            style={
                              {
                                "--color-bg": indicatorColor,
                              } as React.CSSProperties
...
>(
  (
    { className, hideIcon = false, verticalAlign, nameKey, payload, ...props },
    ref
  ) => {
    const { config } = useChart()
...
function getPayloadConfigFromPayload(
  ...
  let itemConfig: ChartConfig[string] | undefined
  ...
  if (key in config) {
    ...
    const configKey = payloadPayload[key as keyof typeof payloadPayload]
